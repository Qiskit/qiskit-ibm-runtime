...
def get_default_session(
    ...
    if (  # pylint: disable=too-many-boolean-expressions
        ...
        # Create a new session if one doesn't exist, or if the user wants to switch backend/channel. Close the session only if all jobs are finished and you don't need to run more in the session.
