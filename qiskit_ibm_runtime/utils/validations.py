    ...
    for circuit in circuits:
        ...
        if message:
            raise IBMInputValueError(
                ...
                "(https://docs.quantum.ibm.com/guides/transpile) for instructions to transform circuits and "
                "the primitive examples (https://docs.quantum.ibm.com/guides/primitives-examples) to see "
