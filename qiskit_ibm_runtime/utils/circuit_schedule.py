...
import os.path
import numpy as np
from plotly.graph_objects import Figure as PlotlyFigure, Scatter  # TODO: replace with TYPE_CHECkING
...
class CircuitSchedule:
    ...
    def __init__(
        ...
        The data is loaded as a list of strings ,each string corresponds to a single scheduled
        hardware instruction, and parsed into a Numpy array to allow efficient filtration and
    ...
    @classmethod
    def _load(cls, circuit_schedule: Union[str, List[str]]) -> List[str]:
