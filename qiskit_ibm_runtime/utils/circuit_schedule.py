...
"""Utilities for working with circuit schedule timing information."""
...
class CircuitSchedule:
    """Encapsulates the data of a Qiskit circuit schedule and the functionality to visualize it.
    ...
    def merge_common_instructions(self) -> None:
        """Merge instructions of the same type based on temporal continuity.
