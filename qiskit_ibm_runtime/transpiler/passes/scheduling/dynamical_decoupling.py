...
class PadDynamicalDecoupling(BlockBasePadder):
    ...
    def __init__(
        ...
        spacings: Union[list[list[float]], list[float]] | None = None,
        skip_reset_qubits: bool = True,
        pulse_alignment: int = 16,
        extra_slack_distribution: str = "middle",
        sequence_min_length_ratios: Union[int, list[int]] | None = None,
        insert_multiple_cycles: bool = False,
        coupling_map: CouplingMap = None,
        alt_spacings: Union[list[list[float]], list[float]] | None = None,
