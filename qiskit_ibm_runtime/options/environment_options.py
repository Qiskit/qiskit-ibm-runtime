...
class EnvironmentOptions:
    ...
    r"""Boolean that indicates whether the job is marked as private. When set to true, 
        ...
        After the results are read or after a specified time after the job is completed, the 
        results are deleted from the service. When set to false, the input parameters and results 
        follow the standard retention behavior.
