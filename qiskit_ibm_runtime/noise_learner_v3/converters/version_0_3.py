...
def noise_learner_v3_inputs_to_0_3(
    instructions: Iterable[CircuitInstruction],
    options: NoiseLearnerV3Options,
) -> ParamsModel:
    """Convert noise learner V3 inputs a V0.3 model."""
...
def noise_learner_v3_inputs_from_0_3(
    model: ParamsModel,
) -> tuple[list[CircuitInstruction], NoiseLearnerV3Options]:
    """Convert a V0.3 model to noise learner V3 inputs."""
...
def noise_learner_v3_result_to_0_3(
    result: NoiseLearnerV3Results,
) -> NoiseLearnerV3ResultsModel:
    """Convert noise learner v3 results to a V0.3 model."""
