...
class FakeBackendV2(BackendV2):
    ...
    differs from earlier :class:`~qiskit_ibm_runtime.fake_provider.FakeBackend` (V1) class in a
    ...
    removes extra abstractions :class:`~qiskit_ibm_runtime.fake_provider.FakeQasmBackend` and
    :class:`~qiskit_ibm_runtime.fake_provider.FakePulseBackend` that were present in V1.
    """
...
class FakeBackend(BackendV1):
    ...
    def __init__(self, configuration: BackendConfiguration, time_alive: int = 10) -> None:
