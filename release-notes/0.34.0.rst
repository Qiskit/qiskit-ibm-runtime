...
- Added support for noise model and level 1 data to local sampler
  ...
  The ``simulator.noise_model`` option of :class:`~qiskit_ibm_runtime.SamplerV2` is now passed
  ...
  Similarly, the ``execution.meas_type`` option of :class:`~qiskit_ibm_runtime.SamplerV2` is now
