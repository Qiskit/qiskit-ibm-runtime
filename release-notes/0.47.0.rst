...
- Building on top of the fake backend snapshot script introduced in `2711 <https://github.com/Qiskit/qiskit-ibm-runtime/pull/2736>`__,
...
- The ``proxies`` and ``ssl_verification`` arguments for ``QiskitRuntimeService``
  are now propagated to the underlying HTTP requests to ```GlobalSearchV2``,
