...
class TestQuantumProgramConverters(IBMTestCase):
    ...
    def test_quantum_program_to_0_2_dev(self):
        """Test the function ``quantum_program_to_0_2_dev``"""
        shots = 100
        ...
        params_model = quantum_program_to_0_2_dev(quantum_program, options)
    ...
    def test_quantum_program_to_0_2_dev_no_argument(self):
        """Test the function ``quantum_program_to_0_2_dev`` when there are no circuit arguments, samplex
        ...
        params_model = quantum_program_to_0_2_dev(quantum_program, ExecutorOptions())
        quantum_program_model = params_model.quantum_program
    ...
    def test_quantum_program_result_from_0_2_dev(self):
        """Test the function ``quantum_program_result_from_0_2_dev``"""
