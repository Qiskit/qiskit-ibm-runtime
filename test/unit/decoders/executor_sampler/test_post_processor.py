...
class TestQuantumProgramItemResultToSamplerPubResult(unittest.TestCase):
    ...
    def test_single_pub_multiple_registers(self):
        ...
        meas_data_c1 = np.random.randint(0, 2, size=(*pub_shape, num_shots, 2), dtype=np.uint8)
        meas_data_c2 = np.random.randint(0, 2, size=(*pub_shape, num_shots, 3), dtype=np.uint8)
